...
#    plt = plot()
    ...
    while True:
        ...
        if done:
            ...
            pd.DataFrame({'scores':plot_scores}).to_excel(scores_filename, index=False)            
            pd.DataFrame({'mean_scores':plot_mean_scores}).to_excel(mean_scores_filename, index=False)            
